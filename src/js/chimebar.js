...
const chimeStyles = `
:root {
  --bg-color: ${lightMode === "light" ? "#000" : "#333"};
  --text-color: ${lightMode === "light" ? "#ddd" : "#eee"};
}
...
#chimebar {
  ...
  & > .description {
    ...
    box-shadow: 0 -16px 0px 0 var(--bg-color);
    color: #ddd;
